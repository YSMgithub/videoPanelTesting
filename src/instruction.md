...
- Соответствуют ли домофония на адресе условиям прописанным выше.
...
- Заходим на веб интерфейс роутера. Пароль также требуется уточнить у абонента, или использовать стандартный. Типовые адреса роутеров 192.168.0.1 192.168.1.1 (часто написано на роутере), или в настройках сети на ноутбуке посмотреть шлюз, он и будет являться адресом роутера.
